...
<html lang="en">
    ...
    <head>
     <title>User(<?php echo $_SESSION['usr_name']; ?>) </title>
     <meta charset="utf-8">
...
div.hero-technology{
  ...
  <div class="container-fluid">
		...
		<div class="col-md-3">
			<div class="profile-sidebar">
				...
				<div class="profile-userpic">
					<img src="card2.png" class="img-responsive" alt="">
				</div>
				<!-- END SIDEBAR USERPIC -->
				<!-- SIDEBAR USER TITLE -->
    ...
    <div class="hero-technology">
        ...
        <p><a class="btn btn-primary btn-lg hero-button" role="button" href="terms.php">Get Started</a></p>
    </div>
